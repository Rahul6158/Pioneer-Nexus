...
def generate_sales_data(filepath, row_count=250):
    ...
    transaction_types = ["Sale", "Sale", "Sale", "Sale", "Sale", "Sale", "Sale", "Sale", "Sale", "Return"]
    ...
    with open(filepath, mode='w', newline='', encoding='utf-8') as f:
        writer = csv.writer(f)
        writer.writerow([
            "order_id", "order_date", "product_name", "region", "warehouse", 
            "transaction_type", "quantity", "unit_price_iqd", "revenue_iqd", "expiry_date"
        ])
        ...
        for i in range(1, row_count + 1):
            ...
            expiry_days = random.choice([random.randint(-30, 29), random.randint(30, 120), random.randint(120, 365)])
...
def generate_inventory_data(filepath, row_count=100):
    ...
    with open(filepath, mode='w', newline='', encoding='utf-8') as f:
        writer = csv.writer(f)
        writer.writerow([
            "batch_id", "product_name", "warehouse", "quantity", 
            "manufactured_date", "expiry_date", "unit_cost_iqd"
        ])
        ...
        for i in range(1, row_count + 1):
            ...
            expiry_days = random.choice([random.randint(-15, 30), random.randint(31, 150), random.randint(151, 365)])
